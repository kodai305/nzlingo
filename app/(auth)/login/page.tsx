...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-gradient-to-b from-indigo-50 to-white p-6">
      <div className="w-full max-w-sm text-center">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-primary">NZLingo</h1>
        ...
        <div className="rounded-2xl bg-surface p-6 shadow-sm">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl bg-surface px-4 py-3 text-sm font-medium text-text shadow-sm ring-1 ring-border transition-all hover:bg-gray-50 active:scale-[0.98]"
          >
